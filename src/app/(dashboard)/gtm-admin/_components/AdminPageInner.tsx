...
const PipelineTab = lazy(() =>
  import("./tabs/PipelineTab").then((m) => ({
    default: m.PipelineTab,
  }))
);
const CostTab = lazy(() =>
  import("./tabs/CostTab").then((m) => ({ default: m.CostTab }))
);
const LeadGenTab = lazy(() =>
  import("./tabs/LeadGenTab").then((m) => ({
    default: m.LeadGenTab,
  }))
);
const UpdatesTab = lazy(() =>
  import("./tabs/UpdatesTab").then((m) => ({
    default: m.UpdatesTab,
  }))
);
const SnapshotsTab = lazy(() =>
  import("./tabs/SnapshotsTab").then((m) => ({
