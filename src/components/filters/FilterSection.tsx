...
export function FilterSection({ title, children, defaultOpen = true, count, onClear }: FilterSectionProps) {
  ...
  return (
    <div className="border-b border-surface-3 py-2.5">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="flex w-full items-center justify-between px-4 py-1 text-xs font-semibold uppercase tracking-wider text-text-tertiary"
      >
